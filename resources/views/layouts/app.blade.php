...
<body class="d-flex flex-column min-vh-100 bg-info">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark shadow-sm">
            <div class="container-fluid">
                ...
                @if(Auth::check())
                    ...
                    @if(Auth::user()->role == 2)
                        <div class="nav-item me-auto mt-1" style="font-weight: bold">
                            <a class="nav-link text-info" href="/managegame">{{ __('Manage Games') }}</a>
                        </div>
                    @endif
                @endif
                            ...
                            <li class="dropdown" style="margin-right: 15%">
                                ...
                                <div class="dropdown-menu text-info" aria-labelledby="navbarDropdown">
                                    @if(Auth::user()->role == 1)
                                        ...
                                        <a class="dropdown-item" href="/friends" onclick="#">
                                            {{ __('Friends') }}
                                        </a>
    ...
    <div class="mt-auto pt-4 pb-3 ps-5 bg-dark text-info text-start">
